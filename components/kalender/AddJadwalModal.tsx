...
interface AddJadwalModalProps {
    ...
    // ✅ Pre-fill dari halaman analisis
...
export function AddJadwalModal({
    ...
    // ✅ Update form kalau props berubah (misal user buka modal setelah navigasi)
    useEffect(() => {
    ...
    // Auto-update title saat type berubah dan ada defaultCrop
            ...
            <form onSubmit={handleSubmit(onFormSubmit)}>
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                    ...
                    <div>
                        ...
                        <select className="form-control-custom form-select-custom" {...register("lahanId", { required: true })}>
